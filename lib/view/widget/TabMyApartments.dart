...
class TabMyApartments extends StatelessWidget {
  final HomeController controller;

  const TabMyApartments({required this.controller});

  @override
  Widget build(BuildContext context) {
    if (controller.myApartmentsList.isEmpty) {
      return  Center(
        child: Text(
"75".tr,
    ...
    return GridView.builder(
      ...
      itemCount: controller.myApartmentsList.length,
      itemBuilder: (context, index) {
        final apt = controller.myApartmentsList[index];
        final address = controller.myAddressesList.firstWhere(
